...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-mesh p-4 font-sans relative overflow-hidden text-white">
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-emerald-500/10 blur-[120px] rounded-full animate-pulse-slow"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-purple-500/10 blur-[120px] rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
            ...
            <Card className="w-full max-w-[440px] bg-white/[0.03] backdrop-blur-[40px] border border-white/10 text-white shadow-[0_50px_100px_rgba(0,0,0,0.5)] relative z-10 overflow-hidden group hover:border-white/20 transition-all duration-700 rounded-[40px]">
                ...
                <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-emerald-500 via-purple-500 to-emerald-500 opacity-50"></div>
                ...
                <CardHeader className="space-y-8 flex flex-col items-center pt-14 pb-4">
                    <div className="relative group/logo">
                        ...
                        <div className="w-24 h-24 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-[30px] -rotate-3 flex items-center justify-center shadow-[0_20px_40px_rgba(16,185,129,0.3)] relative z-10 group-hover/logo:rotate-[-12deg] transition-all duration-700">
                            <MessageSquare className="w-12 h-12 text-white fill-white drop-shadow-2xl" />
                        </div>
                    </div>
                    <div className="text-center space-y-2">
                        <CardTitle className="text-4xl font-black tracking-tighter text-white drop-shadow-2xl uppercase">Initialize</CardTitle>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="space-y-4">
                            <div className="relative group/input">
                                ...
                                <User className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-white/20 group-focus-within/input:text-emerald-400 transition-colors z-10" />
                                <Input
                                    type="text"
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-emerald-500 hover:bg-emerald-400 text-white font-black tracking-[0.2em] uppercase h-14 rounded-2xl transition-all duration-500 transform hover:scale-[1.03] active:scale-[0.97] shadow-[0_15px_30px_rgba(16,185,129,0.3)] border border-white/10 mt-4"
                ...
                <CardFooter className="flex flex-col space-y-4 pt-6 pb-12 bg-white/[0.02] border-t border-white/5">
                    <p className="text-xs font-bold text-white/20 tracking-tight">
                        Known Entity?{" "}
                        <Link to="/login" className="text-emerald-500 font-black tracking-widest uppercase hover:text-emerald-400 hover:underline decoration-emerald-500/30 underline-offset-8 transition-all">
                            Authorize
                        </Link>
                    </p>
                </CardFooter>
